...
public class BookTypeAddIFrame extends JInternalFrame {
	...
	public BookTypeAddIFrame() {
		...
		label_4.setPreferredSize(new Dimension(900, 80));
		label_4.setText("图书类别图片（900*80）");
		panel.add(label_4);
		...
		label_5.setPreferredSize(new Dimension(220, 20));
		...
		button.addActionListener(new ActionListener(){
			public void actionPerformed(final ActionEvent e) {
				...
				int i=BookTypeDao.InsertBookType(bookTypeName.getText().trim(), days.getText().trim(),Double.valueOf(fakuan.getText().trim())/10);
				if(i==1){
