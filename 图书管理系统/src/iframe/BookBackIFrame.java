...
public class BookBackIFrame extends JInternalFrame {
	...
	public final void add() {
		...
		List list=BookBorrowBackDao.selectBookBack(readerISBNs);
	...
	class TableListener extends MouseAdapter {
		public void mouseClicked(final MouseEvent e) {
			...
			List list =BookBorrowBackDao.selectBookTypeFk(table.getValueAt(selRow, 2).toString().trim());
			for(int i=0;i<list.size();i++){
	...
	class BookBackActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			int i=BookBorrowBackDao.UpdateBookBack(bookISBNs, readerISBNs,id);
			System.out.print(i);
			 if(i==1){	
