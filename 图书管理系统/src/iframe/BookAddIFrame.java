...
public class BookAddIFrame extends JInternalFrame {
	...
	public BookAddIFrame() {
		...
		setBounds(120, 120, 450, 320);					// 设置窗体位置和大小
		...
		List list=(List) BookInfoDao.selectBookCategory();//从数据库中取出图书类别
		...
		String[] array=new String[]{"北京出版社","上海出版社",
					"广州出版社","深圳出版社","成都出版社","重庆出版社","曲阜师范大学出版社"};//出版社列表
