...
public class Library extends JFrame {
	...
	private JMenuBar createMenu() { // 创建菜单栏的方法
		...
		bookTypeManageMItem.add(MenuActions.TYPE_ADD);//图书类别添加菜单项
		bookTypeManageMItem.add(MenuActions.TYPE_MODIFY);//图书类别修改菜单项
		baseMenu.add(bookTypeManageMItem);//添加图书类别管理子菜单
		
		JMenu readerManagerMItem = new JMenu("读者信息管理");//新增读者信息管理子菜单
		readerManagerMItem.add(MenuActions.READER_ADD);//读者信息添加菜单项
		readerManagerMItem.add(MenuActions.READER_MODIFY);//读者信息修改菜单项
		baseMenu.add(readerManagerMItem);//添加读者信息管理子菜单
		
		JMenu borrowManagerMItem = new JMenu("图书借阅管理");//新增图书借阅管理子菜单
		borrowManagerMItem.add(MenuActions.BORROW_BOOK);//图书借阅菜单项
		borrowManagerMItem.add(MenuActions.BACK_BOOK);//图书归还菜单项
		baseMenu.add(borrowManagerMItem);//添加新书订购管理子菜单
